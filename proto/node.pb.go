...
type StopTasksRequest struct {
	DealID  *BigInt  `protobuf:"bytes,1,opt,name=dealID" json:"dealID,omitempty"`
	TaskIDs []string `protobuf:"bytes,2,rep,name=taskIDs" json:"taskIDs,omitempty"`
}
...
func (*StopTasksRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{2} }

func (m *StopTasksRequest) GetDealID() *BigInt {
	if m != nil {
		return m.DealID
	}
	return nil
...
func (*QuickBuyRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{3} }
...
func (*DealFinishRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{4} }
...
func (*DealsFinishRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{5} }
...
func (*DealsPurgeRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{6} }
...
func (*DealsReply) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{7} }
...
func (*OpenDealRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{8} }
...
func (*WorkerRemoveRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{9} }
...
func (*WorkerListReply) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{10} }
...
func (*BalanceReply) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{11} }
...
func (*TokenTransferRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{12} }
...
func (*NPPMetricsReply) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{13} }
...
func (*NamedMetrics) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{14} }
...
func (*NamedMetric) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{15} }
...
func init() {
	...
	proto.RegisterType((*StopTasksRequest)(nil), "sonm.StopTasksRequest")
...
type TaskManagementClient interface {
	...
	// Deprecated: use StopTasks instead
	Stop(ctx context.Context, in *TaskID, opts ...grpc.CallOption) (*Empty, error)
	// StopTasks stops several tasks by given IDs
	StopTasks(ctx context.Context, in *StopTasksRequest, opts ...grpc.CallOption) (*ErrorByStringID, error)
...
func (c *taskManagementClient) StopTasks(ctx context.Context, in *StopTasksRequest, opts ...grpc.CallOption) (*ErrorByStringID, error) {
	out := new(ErrorByStringID)
	err := grpc.Invoke(ctx, "/sonm.TaskManagement/StopTasks", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaskManagementServer interface {
	...
	// StopTasks stops several tasks by given IDs
	StopTasks(context.Context, *StopTasksRequest) (*ErrorByStringID, error)
	// PullTask pulls task image back
...
func _TaskManagement_StopTasks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StopTasksRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskManagementServer).StopTasks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sonm.TaskManagement/StopTasks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskManagementServer).StopTasks(ctx, req.(*StopTasksRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _TaskManagement_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TaskManagement_StopTasks_Handler,
		},
	},
...
var _TaskManagement_StopTasksCmd = &cobra.Command{
	Use:   "stopTasks",
	Short: "Make the StopTasks method call, input-type: sonm.StopTasksRequest output-type: sonm.ErrorByStringID",
	RunE: grpccmd.RunE(
		"StopTasks",
		"sonm.StopTasksRequest",
		func(c io.Closer) interface{} {
			cc := c.(*grpc.ClientConn)
			return NewTaskManagementClient(cc)
		},
...
var _TaskManagement_StopTasksCmd_gen = &cobra.Command{
	Use:   "stopTasks-gen",
	Short: "Generate JSON for method call of StopTasks (input-type: sonm.StopTasksRequest)",
	RunE:  grpccmd.TypeToJson("sonm.StopTasksRequest"),
}
...
func init() {
	...
	_TaskManagementCmd.AddCommand(
		...
		_TaskManagement_StopTasksCmd,
		_TaskManagement_StopTasksCmd_gen,
...
var fileDescriptor9 = []byte{
	...
	,
}
